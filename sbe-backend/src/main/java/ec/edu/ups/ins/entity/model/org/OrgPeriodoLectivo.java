...
@NamedStoredProcedureQuery(name = "periodoLectivoPorTipoSolicitud",
        procedureName = "SBE.SBE_CRUD_PKG.p_obt_periodos_parametro",
        resultClasses = OrgPeriodoLectivo.class,
        parameters = {
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "pn_tipo_solicitud", type = Long.class),
                @StoredProcedureParameter(mode = ParameterMode.IN, name = "pn_est_codigo", type = Long.class),
                @StoredProcedureParameter(mode = ParameterMode.REF_CURSOR, name = "pn_periodo_lectivo", type = void.class)
        })
