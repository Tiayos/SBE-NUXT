package ec.edu.ups.ins.entity.model.ins;

import ec.edu.ups.ins.entity.model.sigac.ClienteLocal;
import jakarta.persistence.*;
import java.io.Serializable;
import java.util.Date;

@Entity
@Table(name = "INS_ALUMNO", schema = "INS")
...
public class InsAlumno implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "CLLC_CDG", nullable = false, insertable = false, updatable = false)
    ...
    @JoinColumn(name = "CLLC_CDG", referencedColumnName = "CLLC_CDG", nullable = false)
    ...
    public InsAlumno(Long aluCodigo, long cllcCdg, long argCodigoNac, long argCodigoDom, String aluApellidos, String aluNombres, String aluGenero, String aluVigencia, String audEliminado, String audAdicionado, Date audFechaAdicion, String aluDatosActualizados) {
        this.aluCodigo = aluCodigo;
    ...
    public ClienteLocal getCliente() {
        return cliente;
    }

    public void setCliente(ClienteLocal cliente) {
    ...
    public String toString() {
        return "ups.edu.ec.mavenproject3.InsAlumno[ aluCodigo=" + aluCodigo + " ]";
    }
