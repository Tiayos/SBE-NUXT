  ...
  <FCard>
    <Accordion :activeIndex="1" expandIcon="pi pi-plus" collapseIcon="pi pi-minus">
      <AccordionTab>
        <template #header>
          <FCardSection
            :title="$t('ficha.tituloDatosEconomicos')"
                        ...
                        <InputNumber
                          ...
                          @change="
                            storeClient.llenarCampo(
                              sbeCampoCodigos.VALOR_TOTAL_OTROS_INGRESOS_FAMILIARES,
                              sbeCamposWrapper.totalIngresosMensuales,
                              'DECIMAL'
                            )
                          "
                        />
                      ...
                      <FVerticalStack gap="8" full-width>
                        ...
                        >
                          <Dropdown
                            ...
                            optionValue="codigo"
                            :style="[
                              v$.sbe_tipo_empresa.$error ? { 'border-color': 'red' } : {},
                            ]"
                            required
...
watch(
  () => datosEconomicosMiembrosFamiliarList.value,
  (newValue, oldValue) => {
    auxNumeroMiembrosCompletar();
  }
);
